...
# Version    : 0.1.19                                                                              #
# Python     : 3.10.11                                                                             #
# Filename   : /tests/test_domain/test_data.py                                                     #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
# Email      : john.james.ai.studio@gmail.com                                                      #
# URL        : Enter URL in Workspace Settings                                                     #
# ------------------------------------------------------------------------------------------------ #
# Created    : Wednesday June 21st 2023 10:15:03 pm                                                #
# Modified   : Thursday July 27th 2023 08:48:32 am                                                 #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class TestDataset:  # pragma: no cover
    # ============================================================================================ #
    def test_instantiation(self, dataset, caplog):
        start = datetime.now()
        logger.info(
        ...
        # ---------------------------------------------------------------------------------------- #
        ds = Dataset(dataframe=dataset, x="Income", y="Gender")
        ...
        assert isinstance(ds.describe, pd.DataFrame)
    ...
    def test_sample(self, dataset, caplog):
        ...
        # ---------------------------------------------------------------------------------------- #
        ds = Dataset(dataframe=dataset, x="Income", y="Gender")
        assert isinstance(ds.sample(), pd.DataFrame)
        logger.debug(ds.sample(5))
