...
# Version    : 0.1.19                                                                              #
# Python     : 3.10.12                                                                             #
# Filename   : /tests/test_quantitative/test_descriptive/test_freq.py                              #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
@pytest.mark.freq
class TestContinuousFreqDist:  # pragma: no cover
    # ============================================================================================ #
