...
# Modified   : Tuesday June 20th 2023 06:45:53 pm                                                  #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
from explorer.statistical_analytics import DistGen, DISTRIBUTIONS
...
@pytest.mark.distgen
class TestDistGen:  # pragma: no cover
    # ============================================================================================ #
    def test_distgen(self, dataset, caplog):
        start = datetime.now()
        logger.info(
