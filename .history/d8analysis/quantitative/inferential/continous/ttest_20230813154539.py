...
# Version    : 0.1.19                                                                              #
# Python     : 3.10.10                                                                             #
# Filename   : /d8analysis/quantitative/inferential/continous/ttest.py                             #
# ------------------------------------------------------------------------------------------------ #
# Author     : John James                                                                          #
...
# Modified   : Sunday August 13th 2023 03:45:39 pm                                                 #
# ------------------------------------------------------------------------------------------------ #
# License    : MIT License                                                                         #
...
class TTestResult(StatTestResult):
    ...
    def plot(self) -> None:
        self._ax = self._axes or self._canvas.config().axes
